...
public class SQLStatements {
    ...
    private static String SELECT_MSLIMS_PEPTIDEGROUPS = "select identification.sequence,identification.start,identification.end from identification,spectrum where l_spectrumid = spectrumid and l_projectid = ? and identification.accession = ?";
