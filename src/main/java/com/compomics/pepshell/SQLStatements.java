...
public class SQLStatements {
    ...
    //TODO move these to enums, split up peptide/protein queries and structural db queries
    ...
    private static final String SELECT_COLIMS_PROJECTS = "";
    ...
    private static final String GET_PDBfILES_FOR_PROTEIN_FROM_LINKDB = "";
