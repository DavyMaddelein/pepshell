 ...
 */
public interface FileParserInterface<T extends ExperimentMetaData> {


    public Experiment parseExperimentFile(File aFile) throws CouldNotParseException;

    public Experiment parseExperimentFile(AnnotatedFile<T> annotatedFile) throws CouldNotParseException;
