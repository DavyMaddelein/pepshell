...
public class StatisticsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        histogramPanel1 = new com.compomics.pepshell.view.panels.HistogramPanel();
    ...
    private com.compomics.pepshell.view.panels.HistogramPanel histogramPanel1;
    ...
    private final class runStatistics implements Runnable {
        ...
        private void peptideOccurence(AnalysisGroup anAnalysisGroup) {
            ...
            for (Experiment aProject : anAnalysisGroup) {
                int peptidesFound;
        ...
        private void peptideLengthDistribution(AnalysisGroup aGroup) {
            ...
            for (Experiment aProject : aGroup) {
