 ...
 */
class SequenceCoveragePanel extends javax.swing.JPanel {
    ...
    public void showProteinCoverage(String proteinSequence, ProteinInterface protein) {
        this.showProteinCoverage(proteinSequence, protein, false);
    }

    public void showProteinCoverage(String proteinSequence, ProteinInterface protein, boolean setAsDefaultCoverage) {
