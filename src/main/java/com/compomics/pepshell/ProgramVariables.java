...
import com.compomics.pepshell.controllers.fileparservalidators.FileValidatorInterface;
...
public class ProgramVariables {
    ...
    //database properties
    public static StructureDataSource STRUCTUREDATASOURCE = new ExternalStructureDataSource();
