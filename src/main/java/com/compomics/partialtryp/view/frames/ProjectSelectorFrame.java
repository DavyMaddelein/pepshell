...
import com.compomics.partialtryp.controllers.comparators.CompareProjects;
...
public class ProjectSelectorFrame extends javax.swing.JFrame implements Observer {
    ...
    private void launchMainWindowButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_launchMainWindowButtonMouseReleased
        if (selectedProjectsSet.isEmpty() || referenceProject == null) {
            ...
            new MainWindow(referenceProject, selectedProjectsSet);
            this.dispose();
        }
    ...
    private void fillProjectList() throws SQLException {
        projectList.setListData(projects.getProjects(DbConnectionController.getConnection()).toArray());
    }
