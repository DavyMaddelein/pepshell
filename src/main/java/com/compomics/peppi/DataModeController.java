...
import com.compomics.peppi.controllers.DataSources.AbstractDataSource;
import com.compomics.peppi.controllers.DataSources.DataBaseDataSource;
import com.compomics.peppi.controllers.DataSources.FileDataSource;
...
public class DataModeController {
    ...
    public enum Db {
        ...
        MSLIMS(new MsLimsDataMode()), COLIMS(new CoLimsDataMode()), ELIENDB(new ElienDbDataMode()), FASTA(new FastaDataMode());
