...
public abstract class DataMode {
    ...
    private DataRetrievalInterface dataRetrievalInterface;
    private StructureDataSource structureDataSource;
    private ExperimentDatabase experimentDatabase;
    
    public DataRetrievalInterface getViewPreparationForMode(){
        return dataRetrievalInterface;
    }
    
    public DataRetrievalInterface setViewPreparation(DataRetrievalInterface aAbstractDataRetrieval){
        this.dataRetrievalInterface = aAbstractDataRetrieval;
    ...
    public void setDataRetrievalInterface(DataRetrievalInterface dataRetrievalInterface) {
