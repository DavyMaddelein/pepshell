 ...
 */
public class DownloadLatestVersionFromRepo implements Runnable {
     ...
     */
    public static void downloadLatestVersionFromRepo(Path jarPath) throws IOException, XMLStreamException, URISyntaxException {
        downloadURL = new URL("http", "genesis.ugent.be", "/maven2/");
        downloadLatestVersionFromRepo(jarPath, new String[0], downloadURL);
    }
     ...
     * @throws URISyntaxException
     */
    public static void downloadLatestVersionFromRepo(final Path jarPath, String[] args, URL jarRepositoryRoot) throws IOException, XMLStreamException, URISyntaxException {
    ...
    public DownloadLatestVersionFromRepo setStartFileAfterDownload(boolean startFileAfterDownload) {
        DownloadLatestVersionFromRepo.startFileAfterDownload = startFileAfterDownload;

        return this;
    }

    public DownloadLatestVersionFromRepo setCreateDesktopShortcut(boolean createDesktopShortcut) {
        DownloadLatestVersionFromRepo.createDesktopShortcut = createDesktopShortcut;
        return this;
    }

    public DownloadLatestVersionFromRepo setDeletePreviousVersion(boolean deletePreviousVersion) {
        DownloadLatestVersionFromRepo.deletePreviousVersion = deletePreviousVersion;
        return this;
    }

    public DownloadLatestVersionFromRepo setDownloadURL(URL downloadURL) {
        DownloadLatestVersionFromRepo.downloadURL = downloadURL;
        return this;
    }

    public DownloadLatestVersionFromRepo setFileDAO(FileDAO fileDAO) {
        DownloadLatestVersionFromRepo.fileDAO = fileDAO;
        return this;
    }
     ...
     * @throws URISyntaxException
     */
    public static void downloadLatestVersionFromRepo(final File downloadFolder, String groupId, String artifactId, String iconName, String[] args, URL jarRepository, boolean startDownloadedVersion,
