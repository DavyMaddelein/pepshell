...
public class DbLoginDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        loginPanel = new com.compomics.pepshell.view.panels.dataloading.LoginPanel();
    ...
    void executeLogin() {
        try {
            DbConnectionController.createExperimentDbConnection(loginPanel.getUsernameTextField().getText(), new String(loginPanel.getPasswordField().getPassword()), loginPanel.getUrlTextField().getText(), loginPanel.getDatabaseNameTextField().getText());
            DataModeController.getInstance().selectDataHandler();
            JOptionPane.showMessageDialog(this,"login was successful to" + DataModeController.getInstance().getDb().name());
    ...
    com.compomics.pepshell.view.panels.dataloading.LoginPanel loginPanel;
