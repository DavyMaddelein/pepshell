...
public class ExperimentFileSelectionPanel extends javax.swing.JPanel {
    ...
    public void setFiles(List<AnnotatedFile> aList) {
        ...
        aList.stream().forEach((aFile) -> listModel.addElement(aFile));
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        jList1.getSelectedValuesList().stream()
                .forEach((aSelectedFile) -> listModel.remove(listModel.indexOf(aSelectedFile)));
