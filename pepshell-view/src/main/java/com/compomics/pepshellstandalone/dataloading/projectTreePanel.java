 ...
 */
class projectTreePanel extends JPanel implements DragGestureListener, DropTargetListener, DragSourceListener {
    ...
    DefaultMutableTreeNode addObject(DefaultMutableTreeNode parent, Object child, boolean shouldBeVisible, Icon anIcon) {
    ...
    public void drop(DropTargetDropEvent dtde) {
        ...
        try {
            ...
            ProgramVariables.exceptionBus.post(new ExceptionEvent("move failed",true, Level.WARN));
        }
