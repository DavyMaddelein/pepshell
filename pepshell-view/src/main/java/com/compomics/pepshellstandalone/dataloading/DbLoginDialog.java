...
public class DbLoginDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        loginPanel = new com.compomics.pepshellstandalone.dataloading.LoginPanel();
    ...
    void executeLogin() {
        try {
            if (DbConnectionController.getConnection(loginPanel.getUsernameTextField().getText(), new String(loginPanel.getPasswordField().getPassword()), loginPanel.getUrlTextField().getText(), loginPanel.getDatabaseNameTextField().getText()) != null) {
    ...
    com.compomics.pepshellstandalone.dataloading.LoginPanel loginPanel;
